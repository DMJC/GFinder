...
{
  if ([appName isEqual: [gw gfinderProcessName]] == NO) {
...
- (void)nodeContentsDidChange:(NSDictionary *)info
{
  ...
  if ([operation isEqual: @"GFinderRecycleOutOperation"]
    ...
    if ([operation isEqual: @"GFinderEmptyRecyclerOperation"]
                || [operation isEqual: NSWorkspaceDestroyOperation]) { 
